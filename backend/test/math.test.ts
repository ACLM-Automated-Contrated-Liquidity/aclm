import { estimateFee, getLiquidityFromTick, getPriceFromTick, getTokensAmountFromDepositAmountUSD, getTickFromPrice } from '../lib/math';
import { assert } from 'chai';
import { getLiquidityDelta } from "../lib/math"
import fs from 'fs';
...
describe('estimateFee', () => {
    ...
    const P = 1846.982380737689379344868650600034;//getPriceFromTick(curTick, "6", "18");
    ...
    const { amount0, amount1 } = getTokensAmountFromDepositAmountUSD(P, Pl, Pu, 1, P, 1000);
    console.log(`amount0: ${amount0}, amount1: ${amount1}`);
    const liquidityDelta = getLiquidityDelta(P, Pl, Pu, 269.93531, 0.39341, 6, 18);
