...
export const NETWORKS: { [k: string]: Network } = {
    ethereum: {
        ...
        logoURI: "https://seeklogo.com/images/E/ethereum-logo-EC6CDBA45B-seeklogo.com.png",
    ...
    celo: {
        ...
        logoURI: "/celo.svg",
        isNew: false,
        subgraphEndpoint: "https://api.thegraph.com/subgraphs/name/jesse-sawa/uniswap-celo",
    ...
    arbitrum: {
        ...
        subgraphEndpoint: "https://api.thegraph.com/subgraphs/name/ianlapham/arbitrum-minimal",
    ...
    bnb: {
        ...
        subgraphEndpoint: "https://api.thegraph.com/subgraphs/name/ianlapham/uniswap-v3-bsc",
        totalValueLockedUSD_gte: 100000,
        volumeUSD_gte: 50000,
    },
}
